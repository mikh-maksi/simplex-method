...
# отримання похідних елементів: додавання елементів штучного базису до c_i та A_ij
# Визначення значень за замовчуванням для Z_0, delta_i, fi_i
